...
abstract class $RecordCopyWith<$Res> {
  ...
  @useResult
  $Res call({int weight, DateTime dateTime, String? note, String? imagePath});
}
...
class _$_Record implements _Record {
  ...
  @override
  String toString() {
    return 'Record(weight: $weight, dateTime: $dateTime, note: $note, imagePath: $imagePath)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, weight, dateTime, note, imagePath);
...
abstract class _Record implements Record {
  factory _Record(
      ...
      final String? note,
      final String? imagePath}) = _$_Record;
